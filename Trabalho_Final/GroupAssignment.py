...
class File(MainMenu):
    ...
    headerFood      = ["Comida", "Preço"]
    headerDrink     = ["Bebida", "Preço"]
    headerService   = ["Serviço", "Preço"]
    
    # Read and display foods available from file
    def Food(self):
        rowID = []; counter = 0
        with open(r"C:/Users/mdcli/Documents/POO_Python/Trabalho_Final/FoodOrderingSystem/files/listFoods.csv", mode='r') as fileFoods:
    ...
    def Drink(self):
        rowID = []; counter = 0
        with open(r"C:/Users/mdcli/Documents/POO_Python/Trabalho_Final/FoodOrderingSystem/files/listDrinks.csv", mode='r') as fileDrinks:
    ...
    def Service(self):
        rowID = []; counter = 0
        with open(r"C:/Users/mdcli/Documents/POO_Python/Trabalho_Final/FoodOrderingSystem/files/listServices.csv", mode='r') as fileServices:
...
class OrderMenu(MainMenu):
        ...
        while True:
            ...
            if input_1 in ['C', 'B' ,'S', 'V', 'E']:
                ...
                if   input_1 == 'C':
                    ...
                    OrderMenu.ProcessOrder(self, input_1)                
                elif input_1 == 'V': # back to main menu
    ...
    def ProcessOrder(self, _input_):
        while True:
            ...
            input_1 = int(input("Selecione O que Deseja Pedir: ")) # Prompt and get order
            if _input_ == 'F':
                quantity = str(input("Quantidade: "))
...
class Report(MainMenu):
    ...
    data = []
    def SaveReport(self):
        with open(r"C:/Users/mdcli/Documents/POO_Python/Trabalho_Final/FoodOrderingSystem/files/report.fsd", mode='a') as fileReport:
    ...
    def Save(self):
        for i in range(0, len(self.order)):
            ...
            with open(r"C:/Users/mdcli/Documents/POO_Python/Trabalho_Final/FoodOrderingSystem/files/listReport.csv", mode='a', newline='') as fileReport:
...
class Payment(MainMenu):
    ...
    def displayPayment(self):
        ...
        print(f"Total Price: R${Payment.totalPrice}")
...
class Seller():
    def displaySales():
        ...
        with open(r"C:/Users/mdcli/Documents/POO_Python/Trabalho_Final/FoodOrderingSystem/files/listReport.csv", mode='r') as fileSales:
